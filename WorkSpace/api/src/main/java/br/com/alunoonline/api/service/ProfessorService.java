...
public class ProfessorService {
    ...
    //public void update(Long id, Professor professor) {
        ...
        //Professor professorUpdaterd = professorFronDb.get();

        //professorUpdaterd.setName(professor.getName());
        //professorUpdaterd.setEmail(professor.getEmail());

        //professorRepository.save(professorUpdaterd);
    //}
